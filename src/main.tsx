...
function ContactButton() { return <a href="#contact" className="contact-btn">Contact me <ArrowUpRight size={17}/></a>; }
...
const repositories=[
  ...
  ['03','Pixel Village Portfolio','A living world combining portfolio showcase with procedural generation, seasonal dynamics, and real-time weather simulation in JavaScript.','#','JavaScript']
] as const;
